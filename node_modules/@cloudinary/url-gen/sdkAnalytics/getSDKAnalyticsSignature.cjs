...
var sdkAnalytics_encodeOSVersion = require('./encodeOSVersion.cjs');
require('./base64Map.cjs');
require('./stringPad.cjs');
require('./reverseVersion.cjs');
require('./padVersion.cjs');
...
function getSDKAnalyticsSignature(_trackedAnalytics) {
    ...
    try {
        ...
        var encodedOSVersion = sdkAnalytics_encodeOSVersion.encodeOSVersion(analyticsOptions.osVersion);
